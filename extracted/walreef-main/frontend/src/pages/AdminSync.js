  ...
  return (
    <div className="min-h-screen bg-[#F9FAF9]">
      ...
      <div className="container mx-auto max-w-6xl px-4 py-8 space-y-6">
        {/* Sync Control Card */}
        <div className="bg-white rounded-xl p-6 border border-emerald-100 shadow-sm" data-testid="sync-control-card">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-[#1A4D2E] mb-2">{t('syncControl')}</h2>
          ...
          <button
            ...
            className="w-full bg-[#1A4D2E] text-white py-4 rounded-xl font-bold hover:bg-[#143d24] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        ...
        {/* Sync Status Card */}
        <div className="bg-white rounded-xl p-6 border border-emerald-100 shadow-sm" data-testid="sync-status-card">
          <h2 className="text-xl font-bold text-[#1A4D2E] mb-6">{t('lastSyncStatus')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-[#1A4D2E]" data-testid="sync-status">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold text-gray-700">{t('lastSyncTime')}</h3>
              </div>
              <p className="text-sm text-gray-600" data-testid="last-sync-time">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold text-gray-700">{t('syncedInvoicesCount')}</h3>
              </div>
              <p className="text-2xl font-bold text-[#1A4D2E]" data-testid="sync-count">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold text-gray-700">{t('lastInvoiceNumber')}</h3>
              </div>
              <p className="text-2xl font-bold text-[#1A4D2E]" data-testid="last-invoice">
